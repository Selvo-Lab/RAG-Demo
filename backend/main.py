...
Settings.llm = Ollama(model="qwen2.5:7b-instruct-q4_0", base_url=OLLAMA_BASE_URL, request_timeout=180.0, system_prompt="Odgovaraj isključivo na srpskom jeziku (latinica). " "Ako korisnik koristi drugi jezik, i dalje odgovori na srpskom.",
temperature=0.2,)
